...
const WeatherCard = ({ CityName, coordinates, country, celsius, farenheit, weather }) => {
      ...
      <div className=" bg-linear-to-tr from-blue-950 to-black rounded-2xl space-y-3 py-2 px-3 md:space-y-8 w-full md:max-h-5xl h-fit ">
         ...
         <div className="">
            <div className="flex items-center gap-3">
               ...
               <div >
                  <h3 className="text-7xl font-bold text-white md:text-8xl ">{isCelsius ? celsius : farenheit}</h3>
               </div>
            </div>
            <p className="text-gray-400 md:text-lg"><strong className="text-white ">{weather}  </strong>Feels like </p>
         </div>
      </div>
   )
}
